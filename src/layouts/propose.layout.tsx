export const ProposeLayout = () => {
  return (
    <div className={"h-screen w-full bg-bg_propose bg-cover bg-top xl:px-36 2xl:px-44 flex justify-center items-center"}>
        ...
        <div className={"flex justify-end mt-3"}>
          <div className={"w-7/12 flex flex-col justify-start items-start"}>
            ...
            <div>
              ...
              <p className={"xl:text-lx 2xl:text-2xl text-main_dark font-normal"}>-3D Designer, we provide services</p>
              <p className={"xl:text-lx 2xl:text-2xl text-main_dark font-normal"}>-for developing and tailoring websites</p>
              <p className={"xl:text-lx 2xl:text-2xl text-main_dark font-normal"}>-according to our client's criteria. To make</p>
              <p className={"xl:text-lx 2xl:text-2xl text-main_dark font-normal"}>-our clients stand out amidst their competitors,</p>
            </div>
          </div>
        </div>
        <div
